...
**Лицензионное соглашение (EULA)**. Некоторые папки содержат файлы, распространяемые на условиях лицензионного соглашения (EULA), — смотрите заголовки соответствующих файлов. Основные условия EULA:
❌Коммерческое использование запрещено

❌Публичный хостинг без письменного разрешения запрещён

✅Личное некоммерческое использование разрешено

✅Направляя вклад (Contributions), вы предоставляете лицензиару широкую лицензию

Полный текст — в EULA.txt. Вопросы: andrey.koppalev@mail.ru
