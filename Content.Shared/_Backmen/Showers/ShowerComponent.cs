...
namespace Content.Shared.Backmen.Showers
{
    ...
    public sealed partial class ShowerComponent : Component
    {
        ...
        public SoundSpecifier EnableShowerSound = new SoundPathSpecifier("/Audio/_Backmen/Ambience/Objects/shower_enable.ogg");

        public EntityUid? PlayingStream;

        [DataField("loopingSound")]
        public SoundSpecifier LoopingSound = new SoundPathSpecifier("/Audio/_Backmen/Ambience/Objects/shower_running.ogg");
