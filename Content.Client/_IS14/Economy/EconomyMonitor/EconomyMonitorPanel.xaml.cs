...
/// <summary>
///     The economy monitor's contents, with no window around them. Moved here whole out of
///     <see cref="EconomyMonitorWindow"/> so the same layout serves both the standalone console
///     and the OS application (Docs/_IS14/os-design.md §12.2).
/// </summary>
[GenerateTypedNameReferences]
public sealed partial class EconomyMonitorPanel : BoxContainer
{
