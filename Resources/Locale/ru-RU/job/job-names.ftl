# IS14 Edit - Переименование ролей на кастомные
# Security
job-name-warden = Начальник ЛРР
...
# Service (continued)
job-name-boxer = Мастер боевых искусств
# Security (continued)
job-name-pilot = Офицер космической безопасности
...
JobTechnicalAssistant = Младший инженер
JobVisitor = посетитель
JobWarden = Начальник ЛРР
